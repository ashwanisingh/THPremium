...
//            viewHolder.imgView.setImageResource(R.mipmap.ph_topnews_th);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            ...
            tv_caption = (TextView)view.findViewById(R.id.caption);
            tv_photoCount = (TextView)view.findViewById(R.id.photoCount);
            imgView = (ImageView)view.findViewById(R.id.detail_image);
            shareimgView = (ImageView)view.findViewById(R.id.shareIV);
            downloadimgView = (ImageView)view.findViewById(R.id.downloadIV);
            downloadimgShowView = (ImageView)view.findViewById(R.id.downloadShowIV);
        }
    }
